...
CREATE TABLE `poke` (
  ...
  `height` int NOT NULL,
  `weight` int NOT NULL,
  `type1` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8_general_ci NOT NULL,
  `type2` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8_general_ci DEFAULT NULL,
...
INSERT INTO `poke` (`id`, `name`, `image`, `height`, `weight`, `type1`, `type2`, `poke_id`) VALUES
